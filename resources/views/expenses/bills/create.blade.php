...
@section('content')
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="form-group col-md-6 required {{ $errors->has('vendor_id') ? 'has-error' : ''}}">
                ...
                <div class="input-group">
                    ...
                    <button type="button" onclick="createVendor();" class="btn btn-default btn-icon"><i
                        ...
                        <tr>
                            <td class="text-right" style="vertical-align: middle;" colspan="5">
                                <a href="javascript:void(0)" id="discount-text"
                                   rel="popover">{{ trans('bills.add_discount') }}</a>
                            </td>
                            <td class="text-right">
        ...
        @push('css')
            <link rel="stylesheet"
                  href="{{ asset('../vendor/almasaeed2010/adminlte/plugins/datepicker/datepicker3.css') }}">
