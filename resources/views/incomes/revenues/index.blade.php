...
@section('new_button')
    ...
    <span><a href="{{ url('common/import/incomes/revenues') }}" class="btn btn-default btn-sm"><span
                    class="fa fa-download"></span> &nbsp;{{ trans('import.import') }}</a></span>
    @endpermission
    <span><a href="{{ route('revenues.export', request()->input()) }}" class="btn btn-default btn-sm"><span
            ...
            <div class="table table-responsive">
                <table class="table table-striped table-hover" id="tbl-revenues">
                    ...
                    @foreach($revenues as $item)
                        <tr>
                            <td>
                                <a href="{{ url('incomes/revenues/' . $item->id . '/edit') }}">{{ Date::parse($item->paid_at)->format($date_format) }}</a>
                            </td>
                                ...
                                @if ($item->category->id != $transfer_cat_id)
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li>
                                                <a href="{{ url('incomes/revenues/' . $item->id . '/edit') }}">{{ trans('general.edit') }}</a>
                                            </li>
                                            @permission('create-incomes-revenues')
                                            <li class="divider"></li>
                                            <li>
                                                <a href="{{ url('incomes/revenues/' . $item->id . '/duplicate') }}">{{ trans('general.duplicate') }}</a>
                                            </li>
                                            @endpermission
