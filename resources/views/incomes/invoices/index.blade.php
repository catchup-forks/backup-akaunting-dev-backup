...
@section('new_button')
    ...
    <span><a href="{{ url('common/import/incomes/invoices') }}" class="btn btn-default btn-sm"><span
                    class="fa fa-download"></span> &nbsp;{{ trans('import.import') }}</a></span>
    @endpermission
    <span><a href="{{ route('invoices.export', request()->input()) }}" class="btn btn-default btn-sm"><span
            ...
            <div class="table table-responsive">
                <table class="table table-striped table-hover" id="tbl-invoices">
                    ...
                    <tr>
                        ...
                        <th class="col-md-1">@sortablelink('invoice_status_code', trans_choice('general.statuses', 1))
                        </th>
                    ...
                    @foreach($invoices as $item)
                        <tr>
                            <td>
                                <a href="{{ url('incomes/invoices/' . $item->id . ' ') }}">{{ $item->invoice_number }}</a>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a href="{{ url('incomes/invoices/' . $item->id) }}">{{ trans('general.show') }}</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('incomes/invoices/' . $item->id . '/edit') }}">{{ trans('general.edit') }}</a>
                                        </li>
                                        @permission('create-incomes-invoices')
                                        <li class="divider"></li>
                                        <li>
                                            <a href="{{ url('incomes/invoices/' . $item->id . '/duplicate') }}">{{ trans('general.duplicate') }}</a>
                                        </li>
                                        @endpermission
                                        <li class="divider"></li>
