            ...
            <div class="table table-responsive">
                <table class="table table-striped table-hover" id="tbl-invoices">
                    ...
                    <tr>
                        ...
                        <th class="col-md-3 text-right">@sortablelink('invoiced_at', trans('invoices.invoice_date'))
                        </th>
                    ...
                    @foreach($invoices as $item)
                        <tr>
                            <td><a href="{{ url('customers/invoices/' . $item->id) }}">{{ $item->invoice_number }}</a>
                            </td>
                            ...
                            <td class="text-center"><span
                                        class="label {{ $item->status->label }}">{{ $item->status->name }}</span></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
