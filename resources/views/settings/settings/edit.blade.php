        ...
        <div class="col-sm-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a href="#invoice" data-toggle="tab"
                                    aria-expanded="false">{{ trans('settings.invoice.tab') }}</a></li>
                    <li class=""><a href="#default" data-toggle="tab"
                                    aria-expanded="false">{{ trans('settings.default.tab') }}</a></li>
                    <li class=""><a href="#email" data-toggle="tab"
                                    aria-expanded="false">{{ trans('general.email') }}</a></li>
                    ...
                    <li class=""><a href="#system" data-toggle="tab"
                                    aria-expanded="false">{{ trans('settings.system.tab') }}</a></li>
                </ul>
                    ...
                    <div class="tab-pane tab-margin" id="scheduling">
                        ...
                        <div class="col-sm-6">
                            <label for="cron_command"
                                   class="control-label">{{ trans('settings.scheduling.cron_command') }}</label>
                    ...
                    <div class="setting-buttons">
                        <div class="form-group no-margin">
                            ...
                            <a href="{{ URL::previous() }}" class="btn btn-default"><span
                                        class="fa fa-times-circle"></span> &nbsp;{{ trans('general.cancel') }}</a>
                        </div>
                    </div>
                    @endpermission
                </div>
