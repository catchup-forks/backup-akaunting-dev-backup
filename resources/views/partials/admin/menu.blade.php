    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{{ setting('general.company_logo') ? Storage::url(setting('general.company_logo')) : asset('public/img/company.png') }}"
            ...
            <div class="pull-left info">
                ...
                <ul class="dropdown-menu">
                    @foreach($companies as $com)
                        <li>
                            <a href="{{ url('common/companies/'. $com->id .'/set') }}">{{ str_limit($com->company_name, 18) }}</a>
                        </li>
                    @endforeach
