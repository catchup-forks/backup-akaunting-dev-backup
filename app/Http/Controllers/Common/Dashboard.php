...
class Dashboard extends Controller
{
    ...
    private function calculateAmounts()
    {
        ...
        // Get categories
        $categories = Category::with(['bills', 'invoices', 'payments', 'revenues'])->orWhere('type',
            'income')->orWhere('type', 'expense')->enabled()->get();
    ...
    private function addToIncomeDonut($color, $amount, $text)
    {
        ...
        $this->income_donut['labels'][] = money($amount, setting('general.default_currency'),
                true)->format() . ' - ' . $text;
    ...
    private function addToExpenseDonut($color, $amount, $text)
    {
        ...
        $this->expense_donut['labels'][] = money($amount, setting('general.default_currency'),
                true)->format() . ' - ' . $text;
